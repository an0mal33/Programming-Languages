...
INTERGER, PLUS, EOF = 'INTEGER', 'PLUS', 'EOF'
...
class Interpreter(object):
    ...
    def get_next_token(self):
        ...
        # if so, then return EOF token because there is nor more
        ...
        #if the character is a digit then conver it to
